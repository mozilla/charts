...
Dimension.addEdges(true,  Mozilla, [
	...
	{"name":"Projects", "edges":[
		...
		{"name": "Quantum 1.0.1 (TEF -NPOTB -POVB)",  "description": "TEF, excluding partner bugs and excluding build bugs",
			"esfilter":	{"and":[
		...
		{"name": "Quantum 1.1.0 (Leo)", "partitions":[
		...
		{"name": "Boot2Gecko (Quantum)", "partitions":[
